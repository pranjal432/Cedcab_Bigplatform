<?php
    ...
    echo '<div style="margin-top:60px;text-align:center;">
        ...
        <form method="POST">';
                ...
                <input type="password" name="np" id="npu" placeholder="Enter New Password" style="width:220px;height:35px;border-radius:10px;border:2px solid white;" required><br><br>
                <br>
