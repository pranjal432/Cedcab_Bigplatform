<?php
    ...
    if(isset($_SESSION['userdata'])) {
        echo '<center><h1 style="margin-top:0px;color:yellow;">Welcome <u><b><span style="font-size:50px;">'.$_SESSION['userdata']['username'].'</span></b></u> to the Cancelled Rides Panel </h1></center>';
    } else {
...
<script>
        ...
        $(document).ready(function() {
            ...
            $("#newdiv20").load("cancelledrides_ajax.php");
            ...
            $("#allridesfilters").change(function() {
                ...
                if(allridesfilter=="ride_date") {
                    ...
                    $("#newdiv20").load("cancelledrides_ajax_date.php",function() {
                    ...
                    $("#newdiv20").load("cancelledrides_ajax_distance.php",function() {
                    ...
                    $("#newdiv20").load("cancelledrides_ajax_fare.php",function() {
            ...
            $("#ridedatefilters").change(function() {
                ...
                if(ridedatefilter=="lastweek") {
                    ...
                    $("#newdiv20").load("cancelledrides_ajax_datefilterweek.php",function() {
                    ...
                    $("#newdiv20").load("cancelledrides_ajax_datefiltermonth.php",function() {
