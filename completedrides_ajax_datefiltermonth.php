...
$connn=new Config("localhost","root","pma","ocb");
        ...
        $sql="SELECT * FROM tbl_ride WHERE `ride_date` > DATE_SUB(NOW(), INTERVAL 1 MONTH) AND `status`=2 AND `customer_user_id`='".$_SESSION['userdata']['user_id']."' ORDER BY `ride_date` DESC";
