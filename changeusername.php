    ...
    echo '<div style="margin-top:60px;text-align:center;">
        ...
        if ($result->num_rows > 0) {
            while ($row= $result->fetch_assoc()) {
                echo '<label style="color:#98fc03;font-size:25px;">Current Username:  '.$row['user_name'].'</label><br><br>';
            }
        }

                
            
                echo '<input type="text" name="u" placeholder="Enter New Username" style="width:220px;height:35px;border-radius:10px;border:2px solid white;" required><br><br>
                <br>
